  ...
  return <>
    <div className="h-8 my-4">
      <Tabs orientation="horizontal" value={tab} onChange={handleSetTabValue} className="h-9 px-8 v-tabs" sx={{ minHeight: 36 }}>
        <Tab label={t("SMS Management")} className="min-h-0 text-dark dark:text-white normal-case" />
        <Tab label={t("SMS Logs")} className="min-h-0 text-dark dark:text-white normal-case" />
      </Tabs>
